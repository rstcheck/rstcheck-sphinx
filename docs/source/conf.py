...
#: -- PROJECT INFORMATION --------------------------------------------------------------
project = "rstcheck_sphinx"
author = "Christian Riedel <cielquan@protonmail.com>"
GH_REPO_LINK = "https://github.com/rstcheck/rstcheck-sphinx"
CREATION_YEAR = 2013
...
rstcheck_sphinx_VERSION = metadata(project)["Version"]
release = rstcheck_sphinx_VERSION  #: The full version, including alpha/beta/rc tags
